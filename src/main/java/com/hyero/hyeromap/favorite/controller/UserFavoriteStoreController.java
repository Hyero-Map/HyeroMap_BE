...
public class UserFavoriteStoreController {
    ...
    public ResponseEntity<Void> addFavorite(@PathVariable Long storeId) {
        Long userId = 1L;
    ...
    public ResponseEntity<Void> removeFavorite(@PathVariable Long storeId) {
        Long userId = 1L;
    ...
    @GetMapping("/stores")
    public ResponseEntity<Result<List<StoreDetailResponse>>> getFavoriteStores() {
        Long userId = 1L;
